...
export default async function DreamsPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  const dreamsEveryDays = Number(await configValue("DREAMS_EVERY_DAYS")) || 1;
  ...
  return (
    <PageShell
      title="Dreams"
      description="Aprendizajes destilados de conversaciones. El análisis corre 3 AM UTC con la frecuencia que elijas (y el semanal los domingos). Podés apagarlo o cambiar cada cuántos días corre."
      actions={
        <div className="flex flex-wrap items-center gap-2">
          ...
          <ScheduleSelector initialEnabled={dreamsEnabled} initialEveryDays={dreamsEveryDays} />
        </div>
      }
    >
      {listError && (
